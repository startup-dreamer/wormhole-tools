...
- `rust-developer` — Rust implementation (SDK, CLI commands, chain integrations, VAA parsing)
- `bash-script-craftsman` — Shell scripts and tooling

```
Task tool (subagent_type: rust-developer OR bash-script-craftsman):
