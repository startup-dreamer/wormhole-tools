...
Glob: "crates/**/*.rs"
Grep: "pub fn\|pub struct\|pub enum"
Read: "CLAUDE.md", "Cargo.toml"
...
description: Senior Rust developer for wormhole-cli. Use for CLI commands, SDK modules, VAA parsing, chain integrations, error types, and async patterns.

# Clear scope + deferral
description: Rust test quality auditor. Use after rust-developer writes tests to audit for hollow assertions and missing error cases. Defers to rust-developer for fixes.
...
You are a senior Rust engineer with deep expertise in async Rust, clap v4, and the Wormhole cross-chain protocol for the wormhole-cli workspace.
```
...
**Not in scope** (defer to bash-script-craftsman):
- Shell scripts and CI tooling
